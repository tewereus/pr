...
const {registerUser, loginUser, getAllUsers, viewProfile, getaUser, updateUser, updatePassword, blockUser, unblockUser, deleteAccount, deleteUser, deleteAllUsers, forgotPasswordToken, resetPassword, logout} = require("../controllers/authCtrl")
...
router.get('/all-users', authMiddleware, authorize, getAllUsers)
